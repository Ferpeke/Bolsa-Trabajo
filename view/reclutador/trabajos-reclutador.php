<?php
  ...
  $sql = "SELECT nombre, paterno, materno FROM t_reclutador WHERE correo = '$usuario'";
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <span class="navbar-brand"><i class="fas fa-user-tie mr-2"></i><?php echo $nombre . ' '. $paterno . ' '. $materno ?></span>
              </li>
              <li class="nav-item">
