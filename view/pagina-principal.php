<?php
  ...
  $mostrar = mysqli_fetch_assoc($datos);
  if(isset($mostrar)){
    while ($mostrar) {
          ...
          <div class="box">
            ...
            <div class="container">
              ...
              <div class="row mt-lg-2">
                <div class="col-lg-8 border border-dark text text-justify">
                  <h4 class="text-center">Detalles del Trabajo:</h4>
